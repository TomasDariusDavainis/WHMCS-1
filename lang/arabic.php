...
$_LANG['domainnameserver3'] = "خادم ثانوي 5";
...
$_LANG['navemailssent'] = "البريد المرسل";
...
$_LANG['yourclientareahostingaddons'] = "لديك هذه الاضافات لهذا المنتج";
$_LANG['loginrequired'] = "تسجيل الدخول مطلوب";
$_LANG['unsubscribe'] = "الغاء اشتراك";
$_LANG['emailoptout'] = "مخرج النشرة البريدية";
$_LANG['newsletterunsubscribe'] = "الغاء اشتراك النشرة البريدية";
$_LANG['emailoptoutdesc'] = "حدد لالغاء اشتراك النشرة البريدية";
$_LANG['alreadyunsubscribed'] = "لقد الغيت اشتراكك مسبقا من نشرتنا البريدية";
$_LANG['newsletterresubscribe'] = "إذا كنت ترغب في إعادة الاشتراك يمكنك القيام بذلك من %sMy Details%s منطقة العملاء لدينا في أي وقت.";
$_LANG['unsubscribehashinvalid'] = "فشل إلغاء الاشتراك ، الرجاء الاتصال بالدعم.";
$_LANG['unsubscribesuccess'] = "تم الغاء الاشتراك";
$_LANG['newsletterremoved'] = "شكرا لك , تم حذف بريدك الالكتروني من قاعد بيانات النشرة البريدية";
$_LANG['erroroccured'] = "حدث خطأ";
$_LANG['pwresetsuccessdesc'] = "تمت اعادة تعيين كلمة المرور. %sClick here%s تابع الى منطقة العملاء...";
$_LANG['pwresetenternewpw'] = "من فضلك ادخل كلمة المرور الجديدة المطلوبة أدناه.";
$_LANG['ordererrorsbudomainbanned'] = "اسم النطاق الفرعي الذي اضفته غير مسموح  - يرجى محاولة أخرى";

$_LANG['ticketfeedbacktitle'] = "Feedback Request for Ticket";

$_LANG['nosupportdepartments'] = "لم يتم العثور على أي قسم من أقسام الدعم. يرجى المحاولة مرة أخرى في وقت لاحق.";

$_LANG['feedbackclosed'] = "لا يمكن أن تقدم ملاحظات حتى يتم إغلاق البطاقة";
$_LANG['feedbackprovided'] = "You have already provided feedback for this ticket";
$_LANG['feedbackthankyou'] = "نشكركم لأخذ الوقت لتقديم ملاحظاتك.";
$_LANG['feedbackreceived'] = "وصول الطلب";
...
$_LANG['feedbackclickreview'] = "اضغط هنا لتقييم المساعدة";
$_LANG['feedbackopenedat'] = "فتحت في";
$_LANG['feedbacklastreplied'] = "اخر رد";
$_LANG['feedbackstaffinvolved'] = "مسؤول مشترك";
$_LANG['feedbacktotalduration'] = "إجمالي المدة";
$_LANG['feedbackpleaserate1'] = "يرجى تقييم (على مقياس من 1 إلى 10) مدى رضاك";
$_LANG['feedbackpleasecomment1'] = "يرجى التعليق على مدى";
$_LANG['feedbackhandled'] = "handled this support request";
$_LANG['feedbackworst'] = "اسواء";
$_LANG['feedbackbest'] = "ممتاز";
$_LANG['feedbackimprove'] = "كيف يمكننا جعل تجربتك أفضل في المستقبل?";
$_LANG['pleaserate2'] = "التعامل مع طلب دعم";
$_LANG['returnclient'] = "العودة إلى منطقة العملاء";

$_LANG['clientareanavsecurity'] = "خيارات الامان";
...
$_LANG['twofaenableclickhere'] = "اضغط هنا للتفعيل";
$_LANG['twofadisableclickhere'] = "اضغط هنا لالغاء التفعيل";
...
$_LANG['twofasetupgetstarted'] = "ابدا";
